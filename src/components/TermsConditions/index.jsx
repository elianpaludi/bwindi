          ...
          <div className="terms_content">
            ...
            <div className="flex-col-5">
              <div className="genral-the-bwindi-cl">
                ...
                The Bwindi Club is a collection of digital artworks (NFTs) running on the Polygon network. This website is
                an interface allowing participants to verify and exchange digital collectibles. Users are entirely
                responsible for the safety and management of their own private Polygon wallets and validating all
                transactions and contracts generated by this website before approval. Furthermore, as the Bwindi Club smart
                contract runs on the Polygon network, there is no liability or ability to undo, reverse, or restore any
                transactions.
                <br />
                <br />
                ...
                Each Bwindi the Adventurer is an NFT on the Polygon blockchain. When you purchase an NFT using your
                Polygon Wallet, you own the purchased Bwindi the Adventurer completely. Ownership of the NFT is mediated
                executed by the Smart Contract and the Polygon and there is no reverse action to cancel the ownership after
                it is confirmed by the Polygon network.
                <br />
                <br />
